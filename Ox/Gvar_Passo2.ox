...
main()
{
	...
	println("Script responsavel pela estimacao do modelo da regiao dominante\n");
	println("GVAR Passo 2 Inicializado");
...
//		exit(1);
	...
	for(nCont=0; nCont < rows(aMacroVarNames); ++nCont)
	{
		model.Select("U", {sprint("D_", aMacroVarNames[nCont]), 1, iQtdLags});
	}
