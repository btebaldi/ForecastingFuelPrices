...
fileName = "2025-04-15 - Ox Output Weak Exo.txt"
# C:\Users\bteba\Documents\GitHub\Tese_Cap2\scripts\Ox log interpreters
# "~/GitHub/Tese_Cap2/Ox/2025-04-15 - Ox Output"
fileName = "2025-04-16 Ox Output.txt"

# filepath = file.path(".", "Ox", "output", fileName)
filepath = file.path("~/GitHub/Tese_Cap2/Ox/", fileName)
...
cat(sprintf("Total de 1S: %d\nTotal de regioes que passaram na Exo Fraca: %d", ncount - ncount_2S, ncount_2S))
