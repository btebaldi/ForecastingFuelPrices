...
# Verifica se tem algum dado com buraco ainda.
...
summary(db_com_buraco)

saveRDS(object = db_com_buraco, file = "./database/db_Ox_sem_buraco.rds")

readr::write_csv(x = db_com_buraco, file = "./database/db_Ox_sem_buraco.csv")
